...
namespace DtoGenerator.Tests.Resources
{
    ...
    {
        public static ClientRecordDto AsDto(this ClientRecord entity)
        {
            return (ClientRecordDto)entity;
        }
        public static ClientRecord AsData(this ClientRecordDto dto)
        {
            return (ClientRecord)dto;
        }
        public static IEnumerable<ClientRecordDto> AsDto(this IEnumerable<ClientRecord> entity)
        {
            return  entity.Select(x=>x.AsDto());
        }
        public static IEnumerable<ClientRecord> AsData(this IEnumerable<ClientRecordDto> dtos)
        {
