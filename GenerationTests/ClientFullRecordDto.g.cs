...
namespace DtoGenerator.Tests.Resources
{
    ...
    {
        public static ClientFullRecordDto AsClientFullRecordDto(this ClientFullRecord entity)
        {
            return (ClientFullRecordDto)entity;
        }
        public static ClientFullRecord AsClientFullRecord(this ClientFullRecordDto dto)
        {
            return (ClientFullRecord)dto;
        }
        public static IEnumerable<ClientFullRecordDto> AsClientFullRecordDto(this IEnumerable<ClientFullRecord> entity)
        {
            return  entity.Select(x=>x.AsClientFullRecordDto());
        }
        public static IEnumerable<ClientFullRecord> AsClientFullRecord(this IEnumerable<ClientFullRecordDto> dtos)
        {
